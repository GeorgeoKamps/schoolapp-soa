...
class TeacherDAOTest {
    ...
    void persistAndGetTeacher() throws TeacherDAOException {
        ...
        teacher.setLastname("Ross");
        teacherDAO.insert(teacher);

        List<Teacher> teachers = teacherDAO.getByLastname("Ross");
    ...
    public static void createDummyTeachers() throws TeacherDAOException {
        Teacher teacher = new Teacher();
        teacher.setFirstname("Athan");
        teacher.setLastname("andr");
        teacherDAO.insert(teacher);

        teacher = new Teacher();
        teacher.setFirstname("georgeo");
        teacher.setLastname("kamps");
        teacherDAO.insert(teacher);
